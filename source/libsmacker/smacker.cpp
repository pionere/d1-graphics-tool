...
smk_bw_write(&bw, 81772, 19); // (23,236) -> 228:10
...
smk_bw_write(&bw, 214131, 18); //  (236,74) -> 228:0
...
smk_bw_write(&bw, 273924, 19); //  (89,236) -> 21:230
...
smk_bw_write(&bw, 338, 10); // *12*); //  (25,14)  -> 25:25
...
smk_bw_write(&bw, 119272, 19); //  (236,128) -> 29:22
