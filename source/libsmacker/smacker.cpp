...
smk_bw_write(&bw, 455986, 19); //  (236,128) -> 44:35
...
smk_bw_write(&bw, 306692, 19); //  (236,128) -> 37:227
...
smk_bw_write(&bw, 1259787, 21); //  (128,236) -> (225,30) d21 
...
smk_bw_write(&bw, 407051, 19); //  (236,82) -> 225:12
