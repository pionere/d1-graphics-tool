...
smk_bw_write(&bw, 1029619, 20); // (22,99)
...
smk_bw_write(&bw, 487912, 19); // (23,236)
...
smk_bw_write(&bw, 487912, 19); //  (89,236)
...
smk_bw_write(&bw, 1029619, 20); //  (82,236)
...
smk_bw_write(&bw, 51639, 16); //  (128,89)  
...
smk_bw_write(&bw, 873824, 20); //  (128,182)
