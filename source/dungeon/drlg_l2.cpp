...
static void DRLG_L2()
{
	...
	LogErrorF("CAT", "Dun 8: %d - %d", dungeon[0][20], sglGameSeed);

	DRLG_PlaceThemeRooms(6, 10, DEFAULT_MEGATILE_L2, 0, false);

	LogErrorF("CAT", "Dun 9: %d - %d", dungeon[0][20], sglGameSeed);
	L2CreateArches();
	LogErrorF("CAT", "Dun 10: %d - %d", dungeon[0][20], sglGameSeed);
	L2DoorFix2();
	...
	DRLG_L2Subs();
	DRLG_L2DoorSubs();
	LogErrorF("CAT", "Dun 11: %d - %d", dungeon[0][20], sglGameSeed);
	...
	LogErrorF("CAT", "Dun 12: %d - %d", dungeon[0][20], sglGameSeed);
}
...
void CreateL2Dungeon()
{
	...
	LogErrorF("CAT", "Dun 13: %d - %d", dungeon[0][20], sglGameSeed);
