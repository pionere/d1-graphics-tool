...
const int8_t ObjConvTbl[128] = {
	...
	OBJ_SARC,  // SklKng2.DUN OBJ_ANGEL,
	0, //OBJ_BANNERL,
	0, //OBJ_BANNERM,
	0, //OBJ_BANNERR,
	0,
...
/*OBJ_BOOKSHELFL*/   { OFILE_BSHELF,   0,                                         THEME_NONE,              Q_INVALID,           2,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
/*OBJ_BOOKSHELFR*/   { OFILE_BSHELF,   0,                                         THEME_NONE,              Q_INVALID,           4,            0, OPF_NONE,   OMF_FLOOR | OMF_ACTIVE, FALSE,     ODT_NONE,         3, FALSE,    FALSE,     ALIGN },
...
/*OFILE_L1BRAZ*/   { "L1Braz",   SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L1DOORS*/  { "L1Doors",  IS_DOOROPEN,       2, OAM_SWITCH,            0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_LEVER*/    { "Lever",    SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CHEST1*/   { "Chest1",   SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CHEST2*/   { "Chest2",   SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BANNER*/   { "Banner",   SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SKULPILE*///{ "SkulPile", SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SKULFIRE*/ { "SkulFire", SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SKULSTIK*///{ "SkulStik", SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CRUXSK1*/  { "CruxSk1",  SFX_NONE,          0, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_CRUXSK2*/  { "CruxSk2",  SFX_NONE,          0, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_CRUXSK3*/  { "CruxSk3",  SFX_NONE,          0, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_BOOK1*/    { "Book1",    SFX_NONE,          0, OAM_NONE /*OAM_ONCE*/, 1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BOOK2*/    { "Book2",    SFX_NONE,          0, OAM_NONE /*OAM_ONCE*/, 1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_ROCKSTAN*/ { "Rockstan", SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_ANGEL*///  { "Angel",    SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_GHOST*///  { "Ghost",    SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CHEST3*/   { "Chest3",   SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BURNCROS*/ { "Burncros", SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CANDLE*/// { "Candle",   SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CANDLE2*/  { "Candle2",  SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CANDLABR*///{ "Candlabr", SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_NUDE2*///  { "Nude2",    SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SWITCH2*///{ "Switch2",  SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SWITCH3*///{ "Switch3",  SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SWITCH4*/  { "Switch4",  SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_TNUDEM*/   { "TNudeM",   SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_TNUDEW*/   { "TNudeW",   SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_TSOUL*/    { "TSoul",    SFX_NONE,          0, OAM_NONE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L2DOORS*/  { "L2Doors",  IS_DOOROPEN,       2, OAM_SWITCH,            0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WTORCH4*/  { "WTorch4",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WTORCH3*/  { "WTorch3",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_SARC*/     { "Sarc",     SFX_NONE,          0, OAM_ONCE,              1 | 2,       OBM_UNBREAKABLE, ALIGN },
/*OFILE_FLAME1*/// { "Flame1",   SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_FLAME3*/// { "Flame3",   SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_FIREWAL1*///{ "Firewal1", SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_EXPLOD1*///{ "Explod1",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_EXPLOD2*///{ "Explod2",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_VAPOR1*/// { "Vapor1",   SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_PRSRPLT1*///{ "Prsrplt1", SFX_NONE,          0, OAM_SWITCH,            0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_TRAPHOLE*/ { "Traphole", SFX_NONE,          0, OAM_NONE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_DIRTFALL*///{ "Dirtfall", SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WATER*///  { "Water",    SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_MINIWATR*///{ "MiniWatr", SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WTORCH2*/  { "WTorch2",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WTORCH1*/  { "WTorch1",  SFX_NONE,          0, OAM_LOOP,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BCASE*/    { "BCase",    SFX_NONE,          0, OAM_TRANS,             0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BSHELF*/   { "BShelf",   SFX_NONE,          0, OAM_TRANS,             1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_WEAPSTND*/ { "WeapStnd", SFX_NONE,          0, OAM_TRANS,             1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BKURNS*/// { "Bkurns",   SFX_NONE,          1, OAM_SWITCH,            1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_WATERJUG*///{ "Waterjug", SFX_NONE,          1, OAM_NONE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_BARREL*/   { "Barrel",   IS_BARREL,         1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_BARRELEX*/ { "Barrelex", IS_BARLFIRE,       1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_LSHRINEG*/ { "LShrineG", IS_MAGIC,          2, OAM_ONCE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_RSHRINEG*/ { "RShrineG", IS_MAGIC,          2, OAM_ONCE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BLOODFNT*/ { "Bloodfnt", SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_DECAP*/    { "Decap",    SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_PEDISTL*/  { "Pedistl",  SFX_NONE,          0, OAM_SINGLE,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L3DOORS*/  { "L3Doors",  IS_DOOROPEN,       2, OAM_SWITCH,            0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_PFOUNTN*/  { "PFountn",  SFX_NONE,          0, OAM_LOOP,              1 | 14,      OBM_UNBREAKABLE, ALIGN },
/*OFILE_ARMSTAND*/ { "Armstand", SFX_NONE,          0, OAM_TRANS,             1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_GOATSHRN*/ { "Goatshrn", LS_GSHRINE,        1, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_CAULDREN*/ { "Cauldren", LS_CALDRON,        1, OAM_ONCE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_MFOUNTN*/  { "MFountn",  SFX_NONE,          0, OAM_LOOP,              1 | 14,      OBM_UNBREAKABLE, ALIGN },
/*OFILE_TFOUNTN*/  { "TFountn",  SFX_NONE,          0, OAM_LOOP,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_ALTBOY*/   { "Altboy",   SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_MCIRL1*/   { "Mcirl1",   SFX_NONE,          0, OAM_NONE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_MCIRL2*/   { "Mcirl2",   SFX_NONE,          0, OAM_NONE,              0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_BKSLBRNT*/ { "Bkslbrnt", SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_MUSHPTCH*/ { "Mushptch", SFX_NONE,          0, OAM_TRANS,             1 | 14,      OBM_UNBREAKABLE, ALIGN },
/*OFILE_LZSTAND*/  { "LzStand",  SFX_NONE,          0, OAM_TRANS,             1,           OBM_UNBREAKABLE, ALIGN },
#ifdef HELLFIRE
/*OFILE_L5DOOR*/   { "L5Door",   IS_CROPEN,         2, OAM_SWITCH,            0,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L5SARCO*/  { "L5Sarco",  SFX_NONE,          0, OAM_ONCE,              1 | 2,       OBM_UNBREAKABLE, ALIGN },
/*OFILE_URN*/      { "Urn",      IS_POPPOP2,        1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_URNEXPLD*/ { "Urnexpld", IS_POPPOP3,        1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_L5BOOKS*/  { "L5Books",  SFX_NONE,          0, OAM_NONE /*OAM_ONCE*/, 1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L5CANDLE*/ { "L5Light",  SFX_NONE,          0, OAM_NONE,              1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L5LEVER*/  { "L5Lever",  SFX_NONE,          0, OAM_SWITCH,            1,           OBM_UNBREAKABLE, ALIGN },
/*OFILE_L6POD1*/   { "L6Pod1",   IS_POPPOP5,        1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
/*OFILE_L6POD2*/   { "L6Pod2",   IS_POPPOP8,        1, OAM_ONCE,              1,           OBM_BREAKABLE,   ALIGN },
#endif
	// clang-format on
};
