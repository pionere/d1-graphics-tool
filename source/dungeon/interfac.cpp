...
//    FreeLevelMem();
    ...
    dProgress() << QApplication::tr("minareas(%1, %2, %3) maxareas(%4, %5, %6) avgareas(%7, %8, %9)").arg(minars[1]).arg(minars[2]).arg(minars[3]).arg(maxars[1]).arg(maxars[2]).arg(maxars[3]).arg(avgars[1] / rounds).arg(avgars[2] / rounds).arg(avgars[3] / rounds);
