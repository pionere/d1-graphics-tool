...
bool D1Gfx::patchFallGWalk(bool silent)
{
    ...
    for (int i = 0; i < frameCount; i++) {
        ...
        if (i == 0) {
            change |= setPixelTest(frame, i, 76, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 110, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 110, D1GfxPixel::transparentPixel()); // color0)
        ...
        if (i == 1) {
            ...
            change |= setPixelTest(frame, i, 73, 100, D1GfxPixel::colorPixel(175)); // was tp
            change |= setPixelTest(frame, i, 74, 100, D1GfxPixel::colorPixel(175)); // was tp
            change |= setPixelTest(frame, i, 91, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 103, D1GfxPixel::transparentPixel()); // color191)
            change |= setPixelTest(frame, i, 84, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 82, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 83, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 109, D1GfxPixel::transparentPixel()); // color207)
            change |= setPixelTest(frame, i, 82, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 82, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 83, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 82, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 83, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 76, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 77, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 78, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 79, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 74, 119, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 119, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 76, 119, D1GfxPixel::transparentPixel()); // color0)
        }
        if (i == 2) {
            change |= setPixelTest(frame, i, 71, 96, D1GfxPixel::colorPixel(238)); // was color191)
            change |= setPixelTest(frame, i, 71, 97, D1GfxPixel::colorPixel(237)); // was color191)
            change |= setPixelTest(frame, i, 72, 97, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 73, 97, D1GfxPixel::colorPixel(237)); // was color191)
            change |= setPixelTest(frame, i, 75, 97, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 76, 97, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 71, 98, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 98, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 98, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 74, 98, D1GfxPixel::colorPixel(236)); // was color203)
            change |= setPixelTest(frame, i, 70, 99, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 71, 99, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 72, 99, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 99, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 99, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 70, 100, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 71, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 100, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 100, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 75, 100, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 69, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 101, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 71, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 101, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 101, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 75, 101, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 76, 101, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 69, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 71, 102, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 72, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 102, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 102, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 70, 103, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 71, 103, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 103, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 92, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 104, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 71, 104, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 104, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 104, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 84, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 105, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 71, 105, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 105, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 73, 105, D1GfxPixel::colorPixel(238)); // was color170)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 106, D1GfxPixel::colorPixel(236)); // was color238)
            change |= setPixelTest(frame, i, 71, 106, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 106, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 106, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 92, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 71, 107, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 107, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 107, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 107, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 107, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 107, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 108, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 69, 108, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 70, 108, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 71, 108, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 108, D1GfxPixel::colorPixel(0)); // was color191)
            change |= setPixelTest(frame, i, 76, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 80, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 109, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 69, 109, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 70, 109, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 80, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 88, 109, D1GfxPixel::transparentPixel()); // color207)
            change |= setPixelTest(frame, i, 73, 110, D1GfxPixel::colorPixel(0)); // was color189)
            change |= setPixelTest(frame, i, 74, 110, D1GfxPixel::colorPixel(0)); // was color189)
            change |= setPixelTest(frame, i, 75, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 80, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 110, D1GfxPixel::transparentPixel()); // color223)
            change |= setPixelTest(frame, i, 71, 111, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 83, 111, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 71, 112, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 72, 112, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 73, 112, D1GfxPixel::colorPixel(238)); // was color0)
            change |= setPixelTest(frame, i, 74, 112, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 81, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 113, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 71, 113, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 72, 113, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 73, 113, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 83, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 89, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 73, 114, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 85, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 117, D1GfxPixel::transparentPixel()); // color0)
        ...
        if (i == 3) { // 52
            change |= setPixelTest(frame, i, 68, 87, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 69, 87, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 88, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 88, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 89, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 71, 89, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 90, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 91, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 91, D1GfxPixel::colorPixel(175)); // was color237)
            change |= setPixelTest(frame, i, 77, 91, D1GfxPixel::transparentPixel()); // color237)
            change |= setPixelTest(frame, i, 77, 92, D1GfxPixel::colorPixel(175)); // was tp
            change |= setPixelTest(frame, i, 76, 94, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 95, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 95, D1GfxPixel::colorPixel(175)); // was tp
            change |= setPixelTest(frame, i, 66, 96, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 76, 96, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 96, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 78, 96, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 66, 97, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 76, 97, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 77, 97, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 78, 97, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 66, 98, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 75, 98, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 99, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 99, D1GfxPixel::colorPixel(174)); // was tp
            change |= setPixelTest(frame, i, 75, 99, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 76, 99, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 99, D1GfxPixel::colorPixel(203)); // was color170)
            change |= setPixelTest(frame, i, 73, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 100, D1GfxPixel::colorPixel(174)); // was tp
            change |= setPixelTest(frame, i, 75, 100, D1GfxPixel::colorPixel(174)); // was tp
            change |= setPixelTest(frame, i, 76, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 101, D1GfxPixel::colorPixel(174)); // was tp
            change |= setPixelTest(frame, i, 80, 101, D1GfxPixel::colorPixel(175)); // was tp
            change |= setPixelTest(frame, i, 81, 101, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 67, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 102, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 66, 103, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 67, 103, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 68, 103, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 103, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 103, D1GfxPixel::transparentPixel()); // color189)
            change |= setPixelTest(frame, i, 76, 103, D1GfxPixel::transparentPixel()); // color188)
            change |= setPixelTest(frame, i, 86, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 104, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 104, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 68, 104, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 69, 104, D1GfxPixel::colorPixel(235)); // was color207)
            change |= setPixelTest(frame, i, 81, 104, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 104, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 91, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 105, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 105, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 68, 105, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 72, 105, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 105, D1GfxPixel::transparentPixel()); // color170)
            change |= setPixelTest(frame, i, 84, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 105, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 91, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 106, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 106, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 68, 106, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 72, 106, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 106, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 85, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 107, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 67, 107, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 68, 107, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 107, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 85, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 108, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 108, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 68, 108, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 84, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 67, 109, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 68, 109, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 71, 109, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 83, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 68, 110, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 110, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 76, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 110, D1GfxPixel::colorPixel(0)); // was 235
            change |= setPixelTest(frame, i, 80, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 111, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 72, 111, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 80, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 69, 112, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 112, D1GfxPixel::colorPixel(237)); // was color0
            change |= setPixelTest(frame, i, 84, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 113, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 88, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 72, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 114, D1GfxPixel::colorPixel(0)); // was color188
            change |= setPixelTest(frame, i, 88, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 72, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 118, D1GfxPixel::colorPixel(0)); // was tp
        }
        if (i == 4) { // 53
            change |= setPixelTest(frame, i, 72, 89, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 90, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 73, 91, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 91, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 74, 92, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 75, 94, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 75, 95, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 77, 95, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 78, 95, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 79, 95, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 96, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 77, 96, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 78, 96, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 79, 96, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 80, 96, D1GfxPixel::colorPixel(234)); // was tp
            change |= setPixelTest(frame, i, 77, 97, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 78, 97, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 79, 97, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 65, 98, D1GfxPixel::colorPixel(238)); // was color190)
            change |= setPixelTest(frame, i, 66, 98, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 67, 98, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 76, 98, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 65, 99, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 66, 99, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 67, 99, D1GfxPixel::colorPixel(238)); // was tp
            change |= setPixelTest(frame, i, 76, 99, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 99, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 66, 100, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 67, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 78, 100, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 65, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 66, 101, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 74, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 103, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 77, 103, D1GfxPixel::transparentPixel()); // color188)
            change |= setPixelTest(frame, i, 75, 104, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 104, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 95, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 105, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 83, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 95, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 106, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 83, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 106, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 95, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 74, 107, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 84, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 107, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 95, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 108, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 76, 108, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 86, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 109, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 76, 109, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 86, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 109, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 76, 110, D1GfxPixel::colorPixel(219)); // was color0)
            change |= setPixelTest(frame, i, 77, 110, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 78, 110, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 77, 111, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 78, 111, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 79, 111, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 80, 111, D1GfxPixel::colorPixel(237)); // was color188)
            change |= setPixelTest(frame, i, 81, 111, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 83, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 111, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 77, 112, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 79, 112, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 82, 112, D1GfxPixel::colorPixel(236)); // was color219)
            change |= setPixelTest(frame, i, 83, 112, D1GfxPixel::colorPixel(237)); // was color219)
            change |= setPixelTest(frame, i, 85, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 64, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 65, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 66, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 67, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 69, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 70, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 69, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 70, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 87, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 72, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 115, D1GfxPixel::colorPixel(0)); // was color172)
            change |= setPixelTest(frame, i, 89, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 60, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 61, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 62, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 116, D1GfxPixel::colorPixel(0)); // was color172)
            change |= setPixelTest(frame, i, 89, 116, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 69, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 70, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 80, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 67, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 69, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 70, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 76, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 77, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 56, 120, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 120, D1GfxPixel::transparentPixel()); // color223)
        }
        if (i == 5) { // 54
            change |= setPixelTest(frame, i, 74, 94, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 73, 95, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 95, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 75, 95, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 76, 95, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 77, 95, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 76, 96, D1GfxPixel::colorPixel(174)); // was tp
            change |= setPixelTest(frame, i, 77, 96, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 78, 96, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 74, 97, D1GfxPixel::colorPixel(172)); // was color235)
            change |= setPixelTest(frame, i, 75, 97, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 75, 98, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 76, 98, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 73, 99, D1GfxPixel::colorPixel(237)); // was color0)
            change |= setPixelTest(frame, i, 75, 99, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 76, 99, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 77, 99, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 73, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 100, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 100, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 77, 100, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 73, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 73, 102, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 102, D1GfxPixel::colorPixel(220)); // was tp
            change |= setPixelTest(frame, i, 92, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 73, 103, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 103, D1GfxPixel::colorPixel(220)); // was tp
            change |= setPixelTest(frame, i, 75, 103, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 87, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 73, 104, D1GfxPixel::colorPixel(220)); // was tp
            change |= setPixelTest(frame, i, 74, 104, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 104, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 73, 105, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 74, 105, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 75, 105, D1GfxPixel::colorPixel(172)); // was tp
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 105, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 72, 106, D1GfxPixel::colorPixel(236)); // was color191)
            change |= setPixelTest(frame, i, 73, 106, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 87, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 106, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 93, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 94, 108, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 69, 110, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 70, 110, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 110, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 87, 110, D1GfxPixel::transparentPixel()); // color188)
            change |= setPixelTest(frame, i, 70, 111, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 71, 111, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 72, 111, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 73, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 111, D1GfxPixel::colorPixel(0)); // was tp
            ...
            change |= setPixelTest(frame, i, 82, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 68, 112, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 73, 112, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 82, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 87, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 69, 113, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 113, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 113, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 73, 113, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 74, 113, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 75, 113, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 77, 113, D1GfxPixel::colorPixel(236)); // was color0)
            change |= setPixelTest(frame, i, 89, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 69, 114, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 74, 114, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 114, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 89, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 73, 115, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 88, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 115, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 81, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 90, 117, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 118, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 60, 119, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 57, 120, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 58, 120, D1GfxPixel::colorPixel(0)); // was tp
        }
        if (i == 6) { // 55
            change |= setPixelTest(frame, i, 70, 90, D1GfxPixel::colorPixel(173)); // was color237)
            change |= setPixelTest(frame, i, 71, 91, D1GfxPixel::colorPixel(235)); // was color237)
            change |= setPixelTest(frame, i, 72, 91, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 73, 92, D1GfxPixel::colorPixel(235)); // was tp
            change |= setPixelTest(frame, i, 71, 93, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 93, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 93, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 74, 93, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 72, 94, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 73, 94, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 74, 94, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 94, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 72, 95, D1GfxPixel::colorPixel(221)); // was tp
            change |= setPixelTest(frame, i, 73, 95, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 74, 95, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 75, 95, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 76, 95, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 77, 95, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 78, 95, D1GfxPixel::colorPixel(252)); // was tp
            change |= setPixelTest(frame, i, 73, 96, D1GfxPixel::colorPixel(173)); // was tp
            change |= setPixelTest(frame, i, 74, 96, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 75, 96, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 76, 96, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 77, 96, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 78, 96, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 79, 96, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 80, 96, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 81, 96, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 74, 97, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 75, 97, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 76, 97, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 77, 97, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 78, 97, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 79, 97, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 80, 97, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 74, 98, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 98, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 76, 98, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 77, 98, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 78, 98, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 79, 98, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 75, 99, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 99, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 99, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 78, 99, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 79, 99, D1GfxPixel::colorPixel(203)); // was tp
            change |= setPixelTest(frame, i, 77, 100, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 100, D1GfxPixel::colorPixel(171)); // was tp
            change |= setPixelTest(frame, i, 77, 101, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 93, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 70, 104, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 71, 104, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 72, 104, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 84, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 69, 105, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 70, 105, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 83, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 92, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 68, 106, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 69, 106, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 83, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 106, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 92, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 106, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 68, 107, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 83, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 107, D1GfxPixel::transparentPixel()); // color191)
            change |= setPixelTest(frame, i, 93, 107, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 61, 108, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 62, 108, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 67, 108, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 80, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 108, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 59, 109, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 68, 109, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 69, 109, D1GfxPixel::colorPixel(236)); // was tp
            change |= setPixelTest(frame, i, 72, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 109, D1GfxPixel::colorPixel(0)); // was tp
            ...
            change |= setPixelTest(frame, i, 82, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 109, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 71, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 72, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 77, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 110, D1GfxPixel::colorPixel(0)); // was color171)
            change |= setPixelTest(frame, i, 79, 110, D1GfxPixel::colorPixel(0)); // was color188)
            change |= setPixelTest(frame, i, 80, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 81, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 82, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 110, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 88, 110, D1GfxPixel::transparentPixel()); // color207)
            change |= setPixelTest(frame, i, 77, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 78, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 79, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 80, 111, D1GfxPixel::colorPixel(0)); // was tp
            ...
            change |= setPixelTest(frame, i, 82, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 83, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 111, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 88, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 112, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 76, 113, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 88, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 90, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 113, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 75, 114, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 90, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 93, 114, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 66, 115, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 67, 115, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 83, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 87, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 88, 115, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 64, 116, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 83, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 87, 116, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 73, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 74, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 75, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 76, 117, D1GfxPixel::colorPixel(0)); // was tp
            ...
            change |= setPixelTest(frame, i, 84, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 87, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 64, 118, D1GfxPixel::colorPixel(237)); // was tp
            change |= setPixelTest(frame, i, 84, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 118, D1GfxPixel::colorPixel(0)); // was tp
        }
        if (i == 7) { // 56
            change |= setPixelTest(frame, i, 90, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 91, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 102, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 87, 103, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 88, 103, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 88, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 89, 104, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 92, 104, D1GfxPixel::transparentPixel()); // color191)
            change |= setPixelTest(frame, i, 83, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 84, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 85, 105, D1GfxPixel::transparentPixel()); // color0)
            change |= setPixelTest(frame, i, 86, 105, D1GfxPixel::transparentPixel()); // color0)
            ...
            change |= setPixelTest(frame, i, 85, 112, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 113, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 86, 114, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 117, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 118, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 85, 119, D1GfxPixel::colorPixel(0)); // was tp
            change |= setPixelTest(frame, i, 84, 120, D1GfxPixel::colorPixel(0)); // was tp
        }
