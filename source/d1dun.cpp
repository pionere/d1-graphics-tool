...
void D1Dun::DrawAutomapDoorDiamond(int dir, int x, int y)
{
    ...
    DrawLine(x - d8, y - d16 - d4, x + d16 - d8, y - d16 - d4, COLOR_BRIGHT); // top
    DrawLine(x - d8, y - d4, x + d16 - d8, y - d4, COLOR_BRIGHT);             // bottom
    DrawLine(x - d8, y - d16 - d4, x - d8, y - d4, COLOR_BRIGHT);             // left
    DrawLine(x + d16 - d8, y - d16 - d4, x + d16 - d8, y - d4, COLOR_BRIGHT); // right
}
