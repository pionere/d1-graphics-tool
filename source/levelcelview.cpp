...
void LevelCelView::updateFields()
{
    ...
    if (this->dunView) {
QMessageBox::critical(nullptr, "Error", "updateFields dun 0");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 1");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 2");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 3");
        bool smps = this->dun->getSubtileMonProtectionAt(posx, posy);
QMessageBox::critical(nullptr, "Error", "updateFields dun 4");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 5");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 6");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 7");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 8");
...
QMessageBox::critical(nullptr, "Error", "updateFields dun 10");
    } else {
    ...
    for (int i = 0; i < this->min->getSubtileCount(); i++) {
        ...
        if (trapFlags != PTT_NONE) {
            ...
            if (trapFlags == PTT_LEFT && this->min->getSubtileHeight() > 1) {
                ...
                bool trapLeft = frameRefLeft != 0 && this->gfx->getFrame(frameRefLeft - 1)->getFrameType() == D1CEL_FRAME_TYPE::Square;
                if (!trapLeft) {
                    dProgressWarn() << tr("Subtile %1 is for traps, but the frames above the floor is not square on the left side.").arg(i + 1);
                    result = true;
                }
                ...
                bool trapRight = frameRefRight != 0 && this->gfx->getFrame(frameRefRight - 1)->getFrameType() == D1CEL_FRAME_TYPE::Square;
                if (!trapRight) {
                    dProgressWarn() << tr("Subtile %1 is for traps, but the frames above the floor is not square on the right side.").arg(i + 1);
                    result = true;
                }
            } else {
