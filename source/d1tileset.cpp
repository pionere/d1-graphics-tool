...
/*  0 */{ 304 - 1, 1, D1CEL_FRAME_TYPE::Empty },
/*  1 */{ 304 - 1, 0, D1CEL_FRAME_TYPE::Empty },
/*  2 */{ 306 - 1, 1, D1CEL_FRAME_TYPE::Empty },
...
void D1Tileset::patchCathedralMin(std::set<unsigned> &deletedFrames, bool silent)
{
...
void D1Tileset::patch(int dunType, bool silent)
{
    ...
    case DTYPE_CATHEDRAL:
        ...
        this->patchCathedralMin(deletedFrames, silent);
