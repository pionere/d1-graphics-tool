...
private:
    static bool loadCustomPal(const QString &path, int numcolors, int firstfixcolor, int lastfixcolor, const UpscaleTaskParam &params, D1Pal &pal, UpscaleParam &upParams);
